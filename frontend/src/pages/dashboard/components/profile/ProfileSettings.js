...
import { setShowModal, setProfilePage } from '../../../../redux/globals/globalActions';
...
export default function ProfileSettings() {
  const { Globals: { profilePage: { showSettings } } } = useReduxSelector();
  ...
  return (
    <>
       <CogButton 
         onClick={() => dispatch(setProfilePage('showSettings',!showSettings))}
