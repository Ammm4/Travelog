...
import { createComment, setCommentBody } from '../../../../redux/forums/forumActions';
...
export default function CreateComment() {
  const { User: { user }, Forum: { forum, forum : { commentBody } },  } = useReduxSelector()
  ...
  const handleCreateComment = (e, forumId) => {
    e.preventDefault();
    dispatch(createComment(forumId, { body: commentBody }));
  }
